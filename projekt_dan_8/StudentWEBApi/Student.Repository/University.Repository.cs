...
namespace Student.Repository
{
...

    {
        ...
        public async Task<List<University>> GetUniversitiesAsync(Sorter sorter = null, Pager pager = null, University_filter universityFilter = null)
        {
            Sorter Sorting = new Sorter();
            string sort = Sorting.SortBy(sorter.OrderBy, sorter.Order);
            Pager Paging = new Pager();
            string page = Paging.Paging(pager.Pager_number, pager.Pager_size);
            University_filter Filter = new University_filter();
            string filter = Filter.Filtering(universityFilter.Filter);

            SqlCommand command = new SqlCommand
                ("SELECT * FROM University " + filter + sort + page + ";", con);
            await con.OpenAsync();
