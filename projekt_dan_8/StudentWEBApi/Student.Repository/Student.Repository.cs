...
namespace Student.Repository
{
    public class StudentRepository : IStudentRepository
    {
        ...
        public async Task<List<Students>> GetStudentsAsync(Sorter sorter = null, Pager pager = null, Student_filter studentFilter = null)
        {
            ...
            Student_filter Filter = new Student_filter();
            string filter = Filter.Filtering(studentFilter.Filter);

            SqlCommand command = new SqlCommand
                ("SELECT * FROM Student " + filter + sort + page + ";", con);
            await con.OpenAsync();
